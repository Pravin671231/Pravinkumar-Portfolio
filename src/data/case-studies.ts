...
export const caseStudies: CaseStudy[] = [
  {
    ...
    result:
      "Server-side product search with efficient pagination and total result counting in a single database query.",
    technologies: [
      "MongoDB",
      "Mongoose",
      "TypeScript",
...

  {
    ...
    result:
      "Secure R2 uploads with direct storage transfer, unique object keys, and consistent image validation.",
    technologies: [
      "TypeScript",
      "Express.js",
      "Cloudflare R2",
...

  {
    ...
    result:
      "Flexible category-specific product specifications with consistent validation and safe schema changes.",
    technologies: [
      "Mongoose",
      "MongoDB",
      "TypeScript",
